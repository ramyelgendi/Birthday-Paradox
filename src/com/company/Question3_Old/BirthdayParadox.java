...
public class BirthdayParadox {
  ...
  /* The function runExperiments runs the series of experiments,
    ...
    */
    ...
    private static void seriesOfRanges(){
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter [1] for one series of experiment(s) " +
                            "and any other key for ranged series of experiment(s)");
        ...
        /* the mode specifies which question to
          answer (one range) (series of ranges)*/
